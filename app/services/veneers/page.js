    ...
    <div className="space-y-0 transition-colors duration-300">
      ...
      <section className="bg-ivory-100 dark:bg-navy-950 py-16 sm:py-24 border-b border-ivory-200 dark:border-navy-900 transition-colors duration-300 relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: "url('/aikizi-particle-disperse.png')" }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <span className="text-xs font-bold uppercase tracking-widest text-champagne-600 dark:text-champagne-400 font-sans">
                Custom Porcelain Craftsmanship
              </span>
              <h1 className="font-serif text-4xl sm:text-5xl font-medium text-navy-900 dark:text-ivory-50 leading-tight">
                Porcelain Veneers in New York.<br />
                <span className="italic text-champagne-600 dark:text-champagne-400 font-normal">Handcrafted ceramic smile design.</span>
              </h1>
              <p className="text-sm text-charcoal-700/80 dark:text-ivory-300/80 leading-relaxed font-sans max-w-xl">
                Create a refined, natural-looking smile with ultra-thin porcelain veneers customized for shade, translucency, and facial alignment.
              </p>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                >
                  ...
                  <span>Schedule Veneers Consultation</span>
                </Link>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden shadow-elevated border-4 border-white dark:border-navy-800 aspect-[4/3] bg-ivory-200 dark:bg-navy-900">
                <InteractiveDentalImage
                  ...
                  alt="Porcelain veneers smile makeover at SmileCraft Dental"
                  caption="Aesthetic Porcelain Veneer Preparation Suite - Double tap for high-res view"
                  fill={true}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="max-w-3xl space-y-3">
            <h2 className="font-serif text-3xl font-medium text-navy-900 dark:text-ivory-50">
              The Veneers Experience at SmileCraft
            </h2>
            <p className="text-sm text-charcoal-700/80 dark:text-ivory-300/80 leading-relaxed">
              We collaborate with master ceramic lab technicians to ensure your veneers reflect natural tooth vitality, depth, and light reflection.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-navy-950 p-6 rounded-2xl border border-ivory-200 dark:border-navy-800 shadow-soft space-y-3">
              <h3 className="font-serif text-xl font-bold text-navy-900 dark:text-ivory-50">1. Smile Design Preview</h3>
              <p className="text-xs text-charcoal-700/80 dark:text-ivory-300/80 leading-relaxed">
                We mock up your proposed smile so you can approve length, shape, and shade before ceramic fabrication.
              </p>
            </div>

            <div className="bg-white dark:bg-navy-950 p-6 rounded-2xl border border-ivory-200 dark:border-navy-800 shadow-soft space-y-3">
              <h3 className="font-serif text-xl font-bold text-navy-900 dark:text-ivory-50">2. Minimal Preparation</h3>
              <p className="text-xs text-charcoal-700/80 dark:text-ivory-300/80 leading-relaxed">
                Ultra-thin ceramic allows us to preserve maximum natural tooth structure while enhancing appearance.
              </p>
            </div>

            <div className="bg-white dark:bg-navy-950 p-6 rounded-2xl border border-ivory-200 dark:border-navy-800 shadow-soft space-y-3">
              <h3 className="font-serif text-xl font-bold text-navy-900 dark:text-ivory-50">3. Durable Bond</h3>
              <p className="text-xs text-charcoal-700/80 dark:text-ivory-300/80 leading-relaxed">
                Stain-resistant porcelain ceramic materials bonded securely for long-lasting confidence.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-navy-950 text-ivory-50">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          <h2 className="font-serif text-3xl font-medium text-ivory-50">
            Book your veneer design consultation.
          </h2>
